...
#+begin_src emacs-lisp
  ...
  (set-face-attribute 'variable-pitch nil :font "Nimbus Roman" :height 100)
#+end_src
...
#+begin_src emacs-lisp
  ...
  (use-package devdocs
    ...
    (add-hook 'js-mode-hook
              (lambda()
                (setq-local devdocs-current-docs '("node~16_lts" "javascript"))))
...
#+begin_src emacs-lisp
  (when work-linux-remote
    ...
    (use-package mu4e
      ...
      (mu4e-bookmarks
       (quote
        (("maildir:/INBOX AND NOT flag:trashed" "INBOX only" 73)
