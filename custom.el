(custom-set-variables
 ...
 '(erc-modules
   '(autoaway autojoin button completion dcc fill irccontrols list log match menu move-to-prompt netsplit networks noncommands notifications readonly ring smiley stamp spelling track))
 ...
 '(gud-tooltip-mode t)
 '(ignored-local-variable-values '((dockerfile-image-name . "test")))
